...
@section('content')
    <div class="container" style="padding-top: 70px;">
                <div class="row">
                    <div class="col">
                        <div class="box" style="padding: 15px;">
                            <div class="segment">
                                <p style="  margin-top: 20px; text-align: left;" > <h4 > <b > TAMBAH PENGALAMAN KERJA</b></h4><a href="/user/profil"> <button  type="button"  style="position: relative; top: -30px; float: right;" class="btn-close" aria-label="Close"></button> </a>
            ...
            <form action="/user/experience" method="POST" class="d-block">
                @csrf
                <div class="row">
                    <div class="col">
                        <div class="input-group input-group-lg">
                            <input type="text" name="posisi" class="form-control @error('posisi') is-invalid @enderror" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" placeholder="Posisi">
                        </div>
                        @error('posisi')
                ...
                <div class="row">
                    <div class="col">
                            ...
                            <div class="input-group input-group-lg">
                                ...
                                <input type="text" name="perusahaan" class="form-control @error('perusahaan') is-invalid @enderror" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" placeholder="Perusahaan">
                              </div>
                           @error('posisi')
                            <div class="invalid-feedback">
                                {{$message}}
